...
const de: AdminDictionary = {
  ...
  forms: {
    ...
    statusChange: {
      ...
      sendCustomerEmail: "E-Mail an Kunde und Verkäufer senden",
      skipCustomerEmail: "Keine E-Mail senden",
      current: "Aktuell",
      eta: "ETA",
    ...
    deliveryDate: {
      ...
      submit: "Voraussichtlichen Liefertermin aktualisieren"
    },
    internalNote: {
    ...
    orderDetail: {
      ...
      flashDateChanged: "Voraussichtlicher Liefertermin aktualisiert.",
      ...
      deliveryDateHeading: "Voraussichtlicher Liefertermin",
      deliveryDateIntro: "Änderungen schreiben eine eigene Historie und können optional eine Kunden-E-Mail einreihen.",
      noDatePermission: "Keine Berechtigung für Änderungen am voraussichtlichen Liefertermin.",
      ...
      deliveryHistoryHeading: "Verlauf voraussichtlicher Liefertermin",
      customerNotification: "Kundenbenachrichtigung",
      yes: "ja",
      no: "nein",
      noDeliveryChanges: "Noch keine Änderungen am voraussichtlichen Liefertermin.",
...
const en: AdminDictionary = {
  ...
  forms: {
    ...
    statusChange: {
      ...
      sendCustomerEmail: "Send email to customer and seller",
      skipCustomerEmail: "Do not send any email",
      current: "Current",
      eta: "ETA",
    ...
    deliveryDate: {
      ...
      reason: "Reason",
      saving: "Saving date...",
      submit: "Update estimated delivery date"
    },
    internalNote: {
    ...
    orderDetail: {
      ...
      flashDateChanged: "Estimated delivery date updated.",
      ...
      deliveryDateHeading: "Estimated delivery date",
      deliveryDateIntro: "Changes write their own history and can optionally queue a customer email.",
      noDatePermission: "No permission for estimated delivery date changes.",
      ...
      deliveryHistoryHeading: "Estimated delivery history",
      customerNotification: "Customer notification",
      yes: "yes",
      no: "no",
      noDeliveryChanges: "No estimated delivery changes yet.",
